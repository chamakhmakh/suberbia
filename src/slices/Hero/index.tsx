...
const DEFAULT_TRUCK_COLOR = "#6F6R6A";
const DEFAULT_BOLT_COLOR = "#6F6R6A";
...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 mx-auto mt-24 grid max-w-6xl grid-rows-[1fr,auto]
      ...
      >
        ...
        <div
          className="flex relative w-full flex-col items-center justify-between ~gap-2/4
          lg:flex-row"
        >
