    ...
    <div className="group skater relative flex flex-col items-center gap-4">
      <div className="stack-layout overflow-hidden">
        <PrismicNextImage
          ...
          imgixParams={{ q: 20 }}
          alt=""
          className="scale-11 transform transition-all duration-1000 ease-in-out 
        ...
        <h3
          className="relative grid place-self-end justify-self-start p-2 font-sans 
          text-brand-gray ~text-2xl/3xl"
        >
